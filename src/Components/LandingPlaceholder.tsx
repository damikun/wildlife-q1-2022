...
export function LandingPlaceHolder(){
    ...
    return(
        <div className="h-screen first:pt-4 pt-10 pb-10 bg-black px-4 md:px-6 lg:px-10 xl:px-12 scrollbarhide scrollbarhide2">
            <div className='h-screen relative justify-center align-middle content-center flex overflow-hidden select-none'>
